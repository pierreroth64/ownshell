...
/* This Man Shell shows how to display the full man pages of the Shell application */
...
int main(void) {
    ...
    ShellApp* my_shell = new ShellApp(env, "Man Shell", "man>", mod);
    my_shell->setExitCommand("exit");
    string banner = "Welcome to Man Shell";
    banner += " (based on " + ShellInfo::getName() + " - " + ShellInfo::getVersion() + ")\n";
    my_shell->setWelcomeBanner(banner);
    my_shell->setTopHelp("This Man Shell exits directly and shows the full help (all commands)\n\n");
    cout << my_shell->getMan("txt") << endl;
